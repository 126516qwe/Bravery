...
public class Inventory_Player : Inventory_Base
{
    ...
    public void TryEquipItem(Inventory_Item item)
    {
        ...
        {
            Debug.LogError("Cannot equip:inventoryItem is null!");
            return;
        }
    ...
    {
        float saveedHealthPercet = player.health.GetHeakthPercent();
        slot.equipedItem = itemToEquip;
        slot.equipedItem.AddModifiers(player.stats);
        slot.equipedItem.AddItemEffect(player);


        player.health.SetHealthToPercent(saveedHealthPercet);
    ...
    public void UnequipItem(Inventory_Item itemToUnequip, bool replacingItem = false)
    {
        ...
        float savedHealthPercent = player.health.GetHeakthPercent();
