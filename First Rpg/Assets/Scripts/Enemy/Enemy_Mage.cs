...
public class Enemy_Mage : Enemy,ICounterable
{
    ...
    public Enemy_MageQuickRetreatState mageQuickRetreatState { get; private set; }
    ...
    protected override void Awake()
    {
        ...
        mageQuickRetreatState = new Enemy_MageQuickRetreatState(this, stateMachine, "battle");
