...
public class Player_DomainExpanslonState : PlayerState
{
    ...
    public Player_DomainExpanslonState(Player player, StateMachine stateMachine, string animBoolName) : base(player, stateMachine, animBoolName)
    {
    }
