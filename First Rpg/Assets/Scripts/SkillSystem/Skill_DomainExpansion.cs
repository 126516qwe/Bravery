...
{
    [SerializeField] private GameObject damainPrefab;
    ...
    public void CreateDomain()
    {
        ...
        GameObject domain = Instantiate(damainPrefab, transform.position, Quaternion.identity);
