...
public class UI_Dialogue : MonoBehaviour
{
    ...
    private DialogeuLineSO currentLine;
    private DialogeuLineSO[] currentChoices;
    private DialogeuLineSO selectedChoice;
    ...
    public void PlayDialogueLine(DialogeuLineSO line)
    {
        currentLine = line;
    ...
    private void HandleNextAction()
    {
        ...
        switch (currentLine.actionType)
        {
            ...
            case DialogueActionType.PlayerMakeChoice:
                ...
                {
                    DialogeuLineSO selectedChoice = currentChoices[selectedChoiceIndex];
    ...
    private void ShowChoices()
    {
        for (int i = 0; i < dialogueChoicesText.Length; i++)
        {
            ...
            {
                DialogeuLineSO choice = currentChoices[i];
