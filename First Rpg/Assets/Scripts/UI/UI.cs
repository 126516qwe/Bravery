...
public class UI : MonoBehaviour
{
    ...
    public void SetupControlsUI(PlayerInputSet inputSet)
    {
        ...
        input.UI.AtternativeInput.performed += ctx => alternativeInput = true;
        input.UI.AtternativeInput.canceled += ctx => alternativeInput = false;
    ...
    public void OpenDialogueUI(DialogeuLineSO firstLine,DialogueNpcData npcData)
    {
        StopPlayerControls(true);
        HideAllTooltips();
