...
public class Entity_Stats : MonoBehaviour
{
    ...
    public float GetElementalResistance(ElementType element)
    {
        ...
        float bonusResistance = major.intelligence.GetValue() * 0.5f;//每点智力获得0.5的魔法抗性
        ...
        float resistanCap = 75f;
        float finalResistance = Mathf.Clamp(resistance, 0, resistanCap) / 100;
    ...
    public float GetPhyiscalDamage(out bool isCrit, float scaleFactor = 1f)
    {
        ...
        float finalDamage = isCrit ? baseDamage * (critPower/100) : baseDamage;
        return finalDamage * scaleFactor;
    }
    ...
    public float GetEvasion()
    {
        ...
        float bonusEvasion = major.agility.GetValue() * 5f;//每点敏捷增加5点闪避率

        float totalEvasion = baseEvasion + bonusEvasion;
        float evasionCap = 80f;//闪避上限
    ...
    public float GetMaxHealth()
    {
        ...
        float bonusMaxHealth = major.vitality.GetValue() * 5;//每点活力增加5点生命上限
